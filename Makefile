...
VENV_NAME ?= pyflexplot_test#OPT Name of virtual environment if one is created
...
# 	\rm -f docs/pyflexplot_test.rst
# 	\rm -f docs/modules.rst
# 	${PREFIX}sphinx-apidoc -o docs/ src/pyflexplot_test
# 	$(MAKE) -C docs clean
# 	$(MAKE) -C docs html
